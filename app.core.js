...
function hasAnyPhone(){
  return Array.from(document.querySelectorAll('.phone-input')).some(i=>i.value.trim());
    ...
    const BRAND_OPTS = ['HITACHI 日立','Panasonic 國際牌','DAIKIN 大金','MITSUBISHI 三菱重工','FUJITSU 富士通','LG','TECO 東元','SANLUX 三洋','SAMPO 聲寶','Heran 禾聯','Kolin 歌林','TATUNG 大同','MAXE 萬士益','國產貼牌','其他'];
